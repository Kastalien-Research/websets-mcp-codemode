...
function formatEvent(eventType, body) {
...
export function startChannel() {
    const mcp = new Server({ name: "github-channel", version: "0.1.0" }, {
        capabilities: {
            experimental: { "claude/channel": {} },
        },
        instructions: "GitHub events arrive as <channel> notifications. Attributes include: " +
